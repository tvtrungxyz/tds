...
░░░╚═╝░░░╚═╝░░╚═╝░╚═════╝░╚═╝░░╚══╝░╚═════╝░
            TOOL BY: VAN TRUNG
════════════════════════════════════════════════  
[</>] BOX ZALO : https://zalo.me/trung157
[</>] TELE : @tvt157
[</>] ADMIN TOOL : VANTRUNG 
════════════════════════════════════════════════  
...
"""
    print(banner)
    thanhngang(50)
    print(f'''{thanh} Admin: VanTrung 
{thanh} Bạn Đang Sử Dụng Tool: Trao Đổi Sub Facebook Vip''')
    thanhngang(50)
         
def Delay(value):
	while not(value <= 1):
		value -= 0.123
		print(f'''[VanTrung] [DELAY] [{str(value)[0:5]}] [X    ]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''[VanTrung] [DELAY] [{str(value)[0:5]}] [ X   ]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''[VanTrung] [DELAY] [{str(value)[0:5]}] [  X  ]''', '               ', end = '\r')
...
def Main():
    ...
    if os.path.exists('settingch.json'):
        with open('settingch.json', 'r') as f:
            ...
            print(f'{thanh} Api Key 3xCapcha: {f"{apikey[:3]}########{apikey[-3:]}" if apikey and len(apikey) > 6 else "********"}')
